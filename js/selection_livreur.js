// Variable pour stocker le numéro de commande
let commandeActive = null;

// Ouvre la fenêtre et affiche le numéro de la commande
...
function validerLivraison(nomLivreur) {
    if (commandeActive) {
        ...
        const url = "../php/changement.php?numero=" + commandeActive + "&livreur=" + encodeURIComponent(nomLivreur);
