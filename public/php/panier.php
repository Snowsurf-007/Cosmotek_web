...
<div class="page">
    ...
    <div id="panier-container">
      ...
      <div class="commande">
        ...
        <div class="profile-info">
          ...
          <form action="../php/suppr_panier.php" method="POST">
      ...
      <form action="../php/payer.php" method="POST">
        <div class="rating-box">
          ...
          <div class="ligne">
            <a href="../php/carte.php">Continuer mes achats</a>
  ...
  <?php else: ?>
    ...
    <div class="rating-box">
      ...
      <a href="../php/carte.php">Voir la carte</a>
    </div>
