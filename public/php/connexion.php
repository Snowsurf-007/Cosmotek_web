...
$erreur = '';
$temps_blocage_requis = 900; // 15 minutes en secondes (15 * 60)

// verif blocage au chargement de la page
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_SESSION['tentatives'] < 3) {
    ...
    // Sécurité contre les modifications F12
    ...
    if (empty($erreur)) {
        ...
        function setSession($u, $id = null) {
            ...
            // Réinitialisation complète en cas de réussite
            $_SESSION['tentatives'] = 0; 
            $_SESSION['heure_blocage'] = 0;
        }
    ...
    // Erreurs F12 détectées
    if (!empty($erreur) && $erreur !== "T'es BAN") {
...
<body style="display: flex; flex-direction: column;">
    ...
    <div class="page">
        ...
        <?php else: ?>
            <p style="margin-top: 15px; font-weight: bold;">Le formulaire sera de nouveau disponible dès que le compte à rebours de 15 minutes sera expiré.</p>
        <?php endif; ?>
        <br>
