...
<body style="background-color: #050505; color: white; text-align: center; padding-top: 100px;">
    ...
    <div style="border: 2px solid <?= $couleur ?>; display: inline-block; padding: 40px; border-radius: 20px; background: #111; max-width: 500px;">
        ...
        <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
            <a href="../php/index.php" style="display: inline-block; padding: 10px 20px; background: <?= $couleur ?>; color: black; text-decoration: none; font-weight: bold; border-radius: 5px;">
                Retour à l'accueil
            </a>

            <?php if ($paiement_reussi): ?>
                <a href="../php/avis.php?commande=<?= htmlspecialchars($transaction) ?>" style="display: inline-block; padding: 10px 20px; background: #f1c40f; color: black; text-decoration: none; font-weight: bold; border-radius: 5px;">
                    ⭐ Laisser un avis
                </a>
            <?php endif; ?>
        </div>
