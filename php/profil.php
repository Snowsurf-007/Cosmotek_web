...
<head>
    ...
    <link rel="stylesheet" href="../css/fichier.css" media="screen"/>
...
<div class="page">
    ...
    <div class="profile-info">
            ...
            <?php else: ?>
                <?php foreach ($commandes_livrees as $commande): ?>
                    <div class="historique-item">
                        ...
                        <a href="../php/recommander.php?numero=<?php echo urlencode($commande['numero']); ?>" class="btn-recommander">
        ...
        <div style="margin-top: 20px;">
            <a href="../php/carte.php" style="margin: 10px;">🍽️ Commander maintenant</a>
            <a href="../php/mdprofil.php" style="margin: 10px; background-color: var(--purple-dark);"> Modifier mon profil</a>
            <a href="../php/logout.php" style="margin: 10px; background-color: var(--black-deep);"> Se déconnecter</a>
        </div>
    </div>
</div>
...
<?php if (in_array($_SESSION['statut'], ['admin', 'cuisinier', 'livreur'])):?>
    <div class="page">
        <div style="margin-top: 20px;">
            ...
            <a href="../php/commande.php" style="margin: 10px; background-color: var(--red-normal);"> Espace cuisinier</a>
            <?php endif; ?>
            <?php if ((isset($_SESSION['statut']) && $_SESSION['statut'] === 'admin') || (isset($_SESSION['statut']) && $_SESSION['statut'] === 'livreur')): ?>
            <a href="../php/livraison.php" style="margin: 10px; background-color: var(--red-normal);"> Espace livreur</a>
            <?php endif; ?>
            <?php if (isset($_SESSION['statut']) && $_SESSION['statut'] === 'admin'): ?>
            <a href="../php/admin.php" style="margin: 10px; background-color: var(--red-normal);"> Espace administrateur</a>
            <?php endif; ?>
        </div>
    </div>
    <br><br>
