...
<body>
    ...
    <h2>Utilisateur n°<?php echo htmlspecialchars($id) ?></h2>
    ...
    <form method="post" action="../php/admin.php">
        ...
        <div class="inscription">
            <label>Nom : </label>
            <input type="text" name="nom" id="nom" value="<?php echo htmlspecialchars(strtoupper($utilisateurs[$id]['nom'])); ?>">
        </div>
        <br>
        
        <div class="inscription">
            <label>Prénom : </label>
            <input type="text" name="prenom" id="prenom" value="<?php echo htmlspecialchars(toto($utilisateurs[$id]['prenom'])); ?>">
        </div>
        <br>
        
        <div class="inscription">
            <label>Adresse : </label>
            <input type="text" name="adresse" id="adresse" value="<?php echo htmlspecialchars($utilisateurs[$id]['adresse']); ?>">
        </div>
        <br>
        
        <div class="inscription">
            <label>Statut actuel : </label>
            <span id="affichage-statut"><?php echo htmlspecialchars($utilisateurs[$id]['statut']); ?></span>
            ...
            <input type="hidden" name="statut" id="statut" value="<?php echo htmlspecialchars($utilisateurs[$id]['statut']); ?>">
        </div>
        <br>
        
        <div class="inscription2">
            <label>Email : </label>
            <input type="email" name="email" id="email" value="<?php echo htmlspecialchars($utilisateurs[$id]['email']); ?>">
        </div>
        <br>
        
        <div class="inscription2">
            <label>Point de fidélité : </label>
            <input type="text" name="ptf" id="ptf" value="<?php echo htmlspecialchars($utilisateurs[$id]['fidelite']); ?>">
        </div>
        <br>        
        <div>
